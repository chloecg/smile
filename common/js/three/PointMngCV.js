...
PointMngCV = (function() {
    ...
    */
    function PointMngCV(_v, _id, _obj, _randomNum) {
        ...
        var _degs = [_id * 16, _id * 16.5, _id * 10.9, _id * 19, _id * 10];

        var shapes = [{
                _deg: _degs[0],
                _tx: Math.cos(_degs[0] * Math.PI / 100) * this._rad,
                _ty: Math.sin(_degs[0] * Math.PI / 100) * this._rad,
            },
            {
                _deg: _degs[1],
            ...
            },
            {
                ...
                _ty: Math.sin(_degs[2] * Math.PI / 49.5) * this._rad,
            },
            {
                _deg: _degs[3],
            ...
            {
                _deg: _degs[4],
                _tx: Math.cos(_degs[4] * Math.PI / 45.2) * this._rad,
                _ty: Math.sin(_degs[4] * Math.PI / 9) * this._rad,
            }
        ];
        ...
        this._trgV.x = shapes[index]._tx * 1.35;
        this._trgV.y = shapes[index]._ty * 1.35;
        this._trgV.z = _id * 1.25;
